...
<%
		...
		String hob1 = (String)session.getAttribute("hobby");
		String[] hob2 = hob1.split(" ");
	// DB 연결
...
<%
   for(int i=0; i<hob2.length; i++){
    if(hob2[i].equals("드라이브")){
       %>checked="checked"<%
    }
 }
%>
...
%>
        ...
        <p><label>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" readonly value=<%=session.getAttribute("zipcode") %>></label>
